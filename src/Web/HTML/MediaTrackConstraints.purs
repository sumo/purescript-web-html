...
type MediaTrackConstraints m
  = { deviceId :: Maybe ConstrainDOMString, groupId :: Maybe ConstrainDOMString | m }

type MediaTrackConstraintsBase_ m
  = { deviceId :: OneOf Undefined (ConstrainableArray String), groupId :: OneOf Undefined (ConstrainableArray String) | m }

toNativeMediaTrackConstraints ::
  forall t51 t53 t56 t62 t65.
  Nub
    ( deviceId ::
        OneOf Undefined
          ( OneOf (Array t56)
              { exact :: OneOf Undefined (Array t56)
              , ideal :: OneOf Undefined (Array t56)
              }
          )
    , groupId ::
        OneOf Undefined
          ( OneOf (Array t62)
              { exact :: OneOf Undefined (Array t62)
              , ideal :: OneOf Undefined (Array t62)
              }
          )
    | t51
    )
    t53 =>
  { deviceId :: Maybe (ConstrainedArray t56)
  , groupId :: Maybe (ConstrainedArray t62)
  | t65
  } ->
  ( { deviceId :: Maybe (ConstrainedArray t56)
    , groupId :: Maybe (ConstrainedArray t62)
  ...
  Record t53
toNativeMediaTrackConstraints mtc f =
  Rec.merge
...
type VideoMediaTrackConstraints_
  = MediaTrackConstraintsBase_
...
toNativeVideoMediaTrackConstraints vmtc =
  toNativeMediaTrackConstraints vmtc
    ( \_ ->
...
type AudioMediaTrackConstraints_
  = MediaTrackConstraintsBase_
...
toNativeAudioMediaTrackConstraints amtc =
  toNativeMediaTrackConstraints amtc
    ( \_ ->
...
type MediaTrackConstraints_
  = Boolean |+| Undefined |+| VideoMediaTrackConstraints_ |+| AudioMediaTrackConstraints_
...
boolOrVal ::
  forall t104 t105 t108 t109 t115.
